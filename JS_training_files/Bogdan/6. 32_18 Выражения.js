...
это:
a <= b || c !== d (ответным значением которого будет: true или false)
...
Следующий пример =>
myFunction(c, d) (ответным значением которого будет: результат функций)
=>
...
Идем дальше, мы только что посмотрели результатами любого выражения являются значения, и вот собственно говоря результаты тех выражений которые я написал в этих примерах.
Т.е. результатом этого выражения
'abc'
будет строка
'abc'
...
будет
сумма "a" и "b"
и т.д. следуя предыдущим примерам выражений.
0:37:27
*/